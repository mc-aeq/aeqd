...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/mc-aeq/aeqd/peer)
...
```bash
$ go get -u github.com/mc-aeq/aeqd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/mc-aeq/aeqd/peer#example-package--NewOutboundPeer)  
