...
// reference implementation because aeqd does not handle wallet requests.  The
// separate wallet process listens on the well-known port and forwards requests
// it does not handle on to aeqd.  This approach allows the wallet process
...
// time of writing, aeqd currently places blocks for testnet version 0 in the
