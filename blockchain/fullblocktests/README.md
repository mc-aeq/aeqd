...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/mc-aeq/aeqd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/mc-aeq/aeqd/blockchain/fullblocktests
```
