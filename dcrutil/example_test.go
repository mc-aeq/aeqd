...
func ExampleAmount() {
	...
	// Output:
	// Zero Atom: 0 AEQ
	// 100,000,000 Atoms: 1 AEQ
	// 100,000 Atoms: 0.001 AEQ
}
...
func ExampleAmount_unitConversions() {
	...
	// Output:
	// Atom to kCoin: 444.333222111 kAEQ
	// Atom to Coin: 444333.222111 AEQ
	// Atom to MilliCoin: 444333222.111 mAEQ
	// Atom to MicroCoin: 444333222111 μAEQ
