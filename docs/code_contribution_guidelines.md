...
reason, the aeqd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire aeqd
...
One of the major design goals of all core aeqd packages is to aim for complete
...
contributions.  This is how to get your changes into aeqd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/mc-aeq/aeqd/graphs/contributors)!
...
[ISC license](https://github.com/mc-aeq/aeqd/blob/master/LICENSE).  This is
the same license as all of the code in the aeqd suite.
