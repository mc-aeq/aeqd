...
/*
aeqd is a full-node Decred implementation written in Go.

The default options are sane for most users.  This means aeqd will work 'out of
...
parsed when aeqd starts up.  By default, the configuration file is located at
~/.aeqd/aeqd.conf on POSIX-style operating systems and %LOCALAPPDATA%\aeqd\aeqd.conf
...
Application Options:
  ...
  -d, --debuglevel=         Logging level for all subsystems {trace, debug,
      ...
      --minrelaytxfee=      The minimum transaction fee in AEQ/kB to be
