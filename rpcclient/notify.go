...
func (c *Client) handleNotification(ntfn *rawNotification) {
	...
	case dcrjson.BtcdConnectedNtfnMethod:
		...
		if err != nil {
			log.Warnf("Received invalid aeqd connected "+
				"notification: %v", err)
			return
		}
...
// parseBtcdConnectedNtfnParams parses out the connection status of aeqd
...
//
// NOTE: This is a aeqd extension and requires a websocket connection.
